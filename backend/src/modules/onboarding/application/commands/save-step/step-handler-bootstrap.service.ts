...
export class StepHandlerBootstrapService implements OnModuleInit {
  ...
  onModuleInit(): void {
    ...
    this.registry.register(
      'contractor.business_basics',
      this.contractorBusinessBasics,
    );
    this.registry.register('contractor.first_service', this.contractorService);
    this.registry.register(
      'contractor.service_details',
    ...
    this.registry.register(
      'contractor.quotation_templates',
      this.quotationTemplate,
    );
    this.registry.register(
      'supplier.store_identity',
      this.supplierProfilePatch,
    );
    this.registry.register('supplier.store_details', this.supplierProfilePatch);
    this.registry.register(
      'supplier.business_registration',
      this.supplierProfilePatch,
    );
